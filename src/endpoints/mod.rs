...
impl Message {
    ...
    pub fn validate(&self) -> Result<(), OpenDartError> {
        match self.status.as_str() {
            "000" => Ok(()),
            "010" | "011" | "012" | "013" | "014" | "020" | "021" | "100" | "101" | "800"
            | "900" | "901" => Err(OpenDartError::ApiError(self.to_string())),
            _ => Err(OpenDartError::ApiError(String::from(
                r#"{status: "invalid", message: "received status code not defined in OpenDart API"}"#,
            ))),
        }
    }
}
